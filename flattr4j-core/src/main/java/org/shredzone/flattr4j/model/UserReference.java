...
/**
 * A simple reference to a Flattr user. Two {@link UserReference} are considered equal if
...
public class UserReference implements UserId, Serializable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof UserReference)) {
            return false;
        }
        return id.equals(((UserReference) obj).id);
    }
